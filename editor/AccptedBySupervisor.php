...
<center> <h3> <i> List of requests approved and verified by the supervisor </i> </h3> 
...
<table class="table table-responsive table-hover">
  ...
  <?php
        ...
        {           
            ...
            {            
                if($doc['student_data'][$i]['supervisor_action']=='Accepted')
                {
